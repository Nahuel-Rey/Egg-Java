...
FROM EMPLEADOS 
WHERE (SELECT MAX(SAL_EMP) FROM EMPLEADOS) 
...
SELECT MAX(SAL_EMP) AS 'SALARIO MAS ALTO', MIN(SAL_EMP) AS 'SALARIO MAS BAJO', MAX(SAL_EMP)- MIN(SAL_EMP) AS DIFERENCIA 
FROM EMPLEADOS;
...
SELECT ID_DEPTO,count(*) AS 'NUMERO DE EMPLEADOS' 
FROM EMPLEADOS 
...
SELECT NOMBRE AS 'NOMBRE EMPLEADOS',ID_DEPTO AS 'DEPARTAMENTO' 
FROM EMPLEADOS 
